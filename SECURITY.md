...
If you've found a security issue in `@aquarian-metals/coin-moebius` or any of its sibling packages, please email **security@coinmoebius.com** rather than opening a public issue.
...
- The CDN-hosted bundles at `cdn.coinmoebius.com`.
- The hosted Cloud Worker at `api.coinmoebius.com` and dashboard at `app.coinmoebius.com`.

Out of scope (please do not test):

- Third-party services we integrate with (Stripe, NOWPayments, Cryptomus, Resend, WorkOS, Cloudflare). Report those upstream.
