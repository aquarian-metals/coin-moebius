...
/** Single-provider verifier — the shape Coin Moebius Cloud's `verifyWebhook` consumes. */
 ...
 * IPN secret. Exported so the dogfood Cloud billing webhook can verify with
 * the same routine without re-importing internals.
 */
